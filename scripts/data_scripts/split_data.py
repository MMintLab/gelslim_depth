...
for i in tqdm(range(num_objects)):
    ...
    data = torch.load(os.path.join(data_dir, data_files[i]))
    ...
    train_dict = {'tactile_image': train_tactile_images, 'depth_image': train_depth_images, 'in_hand_pose': train_in_hand_pose}
    val_dict = {'tactile_image': val_tactile_images, 'depth_image': val_depth_images, 'in_hand_pose': val_in_hand_pose}
    test_dict = {'tactile_image': test_tactile_images, 'depth_image': test_depth_images, 'in_hand_pose': test_in_hand_pose}
