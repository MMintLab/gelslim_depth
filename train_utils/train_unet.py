...
#example:
#python3 train_utils/train_unet.py yztheta_rotation_aug 2 1000 0.8 YZa 8 peg1_yztheta pattern1_yztheta --activation_func relu --train_indefinitely --use_difference_image --rotation_augmentation
        ...
        for i, data in enumerate(TrainLoader):
            ...
            if num_train_images_selected < num_images_to_display_live and plot:
                ...
                if save_image:
                    ...
                    object_pt_filename = TrainDataset.pt_file_list[object_index[image_index]]
                    train_ax[num_train_images_selected, 0].set_xlabel(object_pt_filename)
            ...
            with ema.average_parameters():
                ...
                if num_val_images_selected < num_images_to_display_live and plot:
                    ...
                    if save_image:
                        ...
                        object_pt_filename = ValDataset.pt_file_list[object_index[image_index]]
                        validation_ax[num_val_images_selected, 0].set_xlabel(object_pt_filename)
            ...
            with ema.average_parameters():
                ...
                if num_test_images_selected < num_images_to_display_live and plot:
                    ...
                    if save_image:
                        ...
                        object_pt_filename = TestDataset.pt_file_list[object_index[image_index]]
